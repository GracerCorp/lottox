...
- **`countries` & `lotteries`**: ข้อมูลประเทศที่มีผลหวยในระบบ
- **`lotteries`**: ข้อมูลหวยในแต่ละประเทศ โดยประเทศนึงจะมีได้หลายหวย มีฟิลด์ showing_prize เพื่อกำหนดว่าในตาราง ResultTable หรือ Global Lottery Results จะนำรางวัลไหนบ้างมาแสดง
...
- **`user`, `account`, `session`**: ระบบจัดการผู้ใช้งาน (คาดว่ารองรับ NextAuth/Auth.js) พร้อมฟิลด์เพิ่มเติม
- **`articles`**: ระบบข่าวสารและบทความ
