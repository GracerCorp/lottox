      ...
      <div className="max-w-4xl mx-auto space-y-10">
        ...
        <div className="p-6 rounded-xl border border-gray-200 dark:border-white/10 bg-white dark:bg-navy-900/50 backdrop-blur-sm shadow-sm">
          <div className="flex items-start gap-4">
            ...
            <div>
              <h3 className="text-lg font-semibold text-gold-600 dark:text-gold-400 mb-2">
        ...
        {/* Note */}
        <div className="p-5 rounded-xl border border-amber-500/30 bg-amber-50 dark:bg-amber-500/5 shadow-sm">
