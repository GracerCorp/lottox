...
export default async function CountryPage({ params }: PageProps) {
  ...
  // Fetch real core data from the database
  const countryData = await getLotteriesByCountry(countryKey);
  ...
  // Fallback to helper if flag is missing in DB
  const flagDisplay =
    countryData.flag || getFlagUrl(countryKey as "th" | "la" | "vn");
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-2 space-y-8">
          <div className="space-y-4">
            ...
            {countryData.lotteries.length > 0 ? (
                        ...
                        <div className="space-y-2 mb-6">
                          <div className="text-sm text-gray-600 dark:text-gray-400">
                            ...
                            <span className="text-gray-900 dark:text-white font-medium">
                              {lotto.is_active ? "Active" : "Inactive"}
                            </span>
                          </div>
                        </div>
              ...
              <p className="text-gray-500 dark:text-gray-400">
                No active lotteries found for {countryData.name}.
              </p>
            )}
          </div>
          ...
          <div className="mt-12">
            ...
            <TicketVerifier country={countryData.name} />
          </div>
        </div>
            ...
            <div className="space-y-4 text-sm">
              ...
              <div className="p-4 bg-gray-50 dark:bg-navy-900/50 rounded-lg border border-gray-200 dark:border-white/5 mt-4">
                <p className="text-center text-gray-500 dark:text-gray-400 italic text-xs">
                  &quot;Lottery is a tax on people who are bad at math, but a
                  dream for those who need hope.&quot;
                </p>
              </div>
            </div>
          </div>
